...
const WhoWeAre = () => {
  return (
    <div className="p-6 space-y-6 md:space-y-0 text-textSecondary md:grid md:grid-cols-2 gap-6 lg:gap-20 lg:px-20 lg:py-20 bg-primary tracking-wide mt-[-60px]">
      <motion.div
        initial={{ opacity: 0, y: -100 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 1, delay: 1 }}
        viewport={{ once: true }}
        className="col-span-1 md:flex items-center justify-center pt-20"
      >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="space-y-3 md:space-y-6 col-span-1 pt-20"
      >
        <div>
