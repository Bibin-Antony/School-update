      ...
      <div className="grid grid-cols-2 ">
        <button
          ...
          className={`${
            ...
            news && "  border-t-white border-r-white border-l-primary border-b-primary border-4"
        ...
        <button
          ...
          className={`${
            ...
            !news && "border-l-white  border-t-white border-b-primary border-r-primary border-4"
